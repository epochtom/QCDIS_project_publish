...
class CFG:
    ...
    performance_plot_name = "performance_summary.png"  # Updated name
...
def plot_overall_performance(accuracy, f1_weighted, save_path):
    ...
    plt.title('Overall Model Performance (XGBoost)', fontsize=14, fontweight='bold', pad=20)
...
def main():
    print("="*70)
    print(" QUANTUM PCA + XGBOOST CLASSIFIER + PERFORMANCE PLOT ".center(70))
    print("="*70)
    ...
    print(f" MODEL: QuantumKernelPCA({CFG.N_QUBITS}qb) → XGBClassifier")
    print("="*70)
